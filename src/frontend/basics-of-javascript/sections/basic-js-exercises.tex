...
\begin{codeenv}{code:validity-of-number-examples}{\excref{exc:validity-of-number} examples}
\begin{verbatim}
> isValidNumber(9);
true
> isValidNumber('4');
...
\begin{codeenv}{code:divisors-examples}{\excref{exc:divisors} examples}\begin{verbatim}
> getDivisors(5);
[ 1, 5 ]
> getDivisors(24);
[ 1, 2, 3, 4, 6, 8, 12, 24 ]
...
\begin{codeenv}{code:ellipse-object-examples}{\excref{exc:ellipse-object} examples}
\begin{verbatim}
> const ellipse = {
      width: 10,
      height: 5,
