...
\coderef{code:exercise-dom-1}\을 참고하여 버튼을 클릭하면 \cd{\#color-box}의 배경색을 랜덤하게 바꾸는 \cd{setRandomBgColor} 함수를 script.5.1.js에 작성하여라. 색상은 R, G, B의 값으로 표현될 수 있고, 각 값은 0 이상 255 이하의 정수임을 이용하여라.
