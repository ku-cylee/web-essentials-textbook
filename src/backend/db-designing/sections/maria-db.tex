...
\begin{shell}{shell:create-kwebuser-user}{Create \cd{kwebuser} User}
...
\begin{shell}{shell:grant-kwebdb1-to-kwebuser}{Grant All Privileges on \cd{kwebdb1} Table to ``kwebuser'' User}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
