...
\begin{shell}{shell:sql-insert-example}{\cd{INSERT} Example}
...
\begin{shell}{shell:insert-without-column-names}{\cd{INSERT} Without Column Names Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:insert-with-default-values}{\cd{INSERT} With Default Values Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:sql-select-example}{\cd{SELECT} Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:sql-select-all-columns}{\cd{SELECT} All Columns Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:sql-select-without-condition}{\cd{SELECT} Without Condition Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:sql-update-example}{\cd{UPDATE} Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
...
\begin{shell}{shell:sql-delete-example}{\cd{DELETE} Example}
\begin{minted}[linenos=false, xleftmargin=2pt]{sql}
