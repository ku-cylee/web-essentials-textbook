...
\begin{code}{code:random-color-box-html}{\excref{exc:random-color-box} HTML code}
\begin{minted}{html}
<!doctype html>
<head>
...
\begin{code}{code:times-table-html}{\excref{exc:times-table} HTML code}
\begin{minted}{html}
<!doctype html>
<head>
...
\begin{code}{code:box-color-btn-html}{\excref{exc:box-color-btn} HTML code}
\begin{minted}{html}
<!doctype html>
<head>
...
\begin{code}{code:random-level-up-html}{\excref{exc:random-level-up} HTML code}
\begin{minted}{html}
<!doctype html>
<head>
...
\begin{code}{code:online-shopping-cart-html}{\excref{exc:online-shopping-cart} HTML code}
\begin{minted}{html}
<!doctype html>
<head>
...
\begin{code}{code:maze-escaping-game-css}{\excref{exc:maze-escaping-game} CSS code}
\begin{minted}{css}
#maze {
    margin: 30px;
    font-size: 0
...
\begin{code}{code:maze-escaping-game-html}{\excref{exc:maze-escaping-game} HTML code}
\begin{minted}{html}
<html>
<head>
