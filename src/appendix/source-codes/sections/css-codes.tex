...
\begin{code}{code:text-styling-html-code}{\excref{exc:text-styling} - HTML code}
\begin{minted}{html}
<!doctype html>
<html>
<head>
...
\begin{code}{code:ars-buttons-html-code}{\excref{exc:ars-buttons} - HTML code}
\begin{minted}{html}
<!doctype html>
<html>
<head>
...
\begin{code}{code:scroll-button-html-code}{\excref{exc:scroll-button} HTML code}
\begin{minted}{html}
<!doctype html>
<html>
<head>
...
\begin{code}{code:responsive-color-page-html-code}{\excref{exc:responsive-color-page} - HTML code}
\begin{minted}{html}
<!doctype html>
<html>
<head>
...
\begin{code}{code:responsive-layout-html-code}{\excref{exc:responsive-layout} - HTML code}
\begin{minted}{html}
<!doctype html>
<html>
<head>
