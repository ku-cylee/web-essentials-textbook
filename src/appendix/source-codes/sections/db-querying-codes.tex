\section{Database Querying Source Codes}\label{sect:db-querying-codes}

\begin{code}{code:scores-table-sql}{\cd{scores} Table SQL}
\begin{minted}{sql}
CREATE TABLE `scores` (
...
\begin{code}{code:join-example-sql}{SQL Join Example Data}
\begin{minted}{sql}
...
\begin{code}{code:university-system}{University System SQL}
\begin{minted}{sql}
...
\begin{code}{code:crud-table-sql}{\cd{crud} Table SQL}
\begin{minted}{sql}
CREATE TABLE `crud` (
...
\begin{code}{code:train-system-tables}{Train System Tables SQL}
\begin{minted}{sql}
...
\begin{code}{code:train-system-data}{Train System Data SQL}
\begin{minted}{sql}
