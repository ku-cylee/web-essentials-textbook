...
\begin{codeenv}{code:random-color-box-answer}{\excref{exc:random-color-box} Answer}
\begin{verbatim}
...
\begin{codeenv}{code:times-table-answer}{\excref{exc:times-table} Answer}\begin{verbatim}
...
\begin{codeenv}{code:box-color-btn-answer}{\excref{exc:box-color-btn} Answer}
\begin{verbatim}
...
\begin{codeenv}{code:random-level-up-answer}{\excref{exc:random-level-up} Answer}
\begin{verbatim}
...
\begin{codeenv}{code:online-shopping-cart-answer}{\excref{exc:online-shopping-cart} Answer}
\begin{verbatim}
const itemPrice = {
    apple: 700,
    orange: 800,
...
\begin{codeenv}{code:maze-escaping-game-answer}{\excref{exc:maze-escaping-game} Answer}
\begin{verbatim}
const ROW_MIN = 0;
const ROW_MAX = 6;
const COL_MIN = 0;
