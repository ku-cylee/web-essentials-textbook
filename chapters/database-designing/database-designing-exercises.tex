...
각 테이블의 SQL문을 모두 ex4.2.sql 파일에 \coderef{code:exercise-4-2-example}\과 같이 ex4.2.sql에 작성하여라. SQL문을 DB에서 실행시켜 잘 작동시켜 확인해보고, \cd{DESC} 키워드를 이용해 의도한 바와 같이 설계되었는지 확인해본다.
...
-\item chats / blocks table code here
