...
각 테이블의 SQL문을 모두 messenger.sql 파일에 \coderef{code:messenger-db-design-example}\과 같이 messenger.sql에 작성하여라. SQL문을 DB에서 실행시켜 잘 작동시켜 확인해보고, \cd{DESC} 키워드를 이용해 의도한 바와 같이 설계되었는지 확인해본다.
