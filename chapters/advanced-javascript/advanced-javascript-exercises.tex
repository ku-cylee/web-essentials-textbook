...
\subsection*{\excstref{exc:cases-module}}
...
\subsection*{\excstref{exc:directory-search}}
...
예를 들어 test 폴더의 내부 구조가 \shellref{shell:directory-search-example}\과 같을 때, 프로그램의 실행 결과는 \shellref{shell:directory-search-example-result}\와 같아야 한다.
