\section{Database Designing Exercise Answers}\label{sect:database-designing-answers}

\subsection*{\excref{exc:students-table-design}}

\begin{codeenv}{code:students-table-design-answer}{\excref{exc:students-table-design} Answer}\begin{verbatim}
...
\subsection*{\excref{exc:messenger-table-design}}

\begin{codeenv}{code:messenger-table-design-answer}{\excref{exc:messenger-table-design} Answer}\begin{verbatim}
CREATE TABLE `users` (
    `id` INT NOT NULL AUTO_INCREMENT,
