...
\coderef{code:child-desc-selector}를 통해 이해해보자. 자식 선택자인 \verb|.class1 > span|은 \verb|#span1|만 선택하나, 자손 선택자인 \texttt{.class1 span}은 \verb|#span1과 #span3|를 선택한다.
...
이 외에도, \verb|:not(selector)|은 \verb|selector|에 의해 선택되지 않는 요소들만 선택한다.
