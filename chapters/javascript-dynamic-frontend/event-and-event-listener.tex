...
마지막 방법은 요소의 \texttt{addEventListener} 메서드를 사용하는 방법으로, \texttt{addEventListener} 메서드는 이벤트의 이름과 이벤트 리스너를 인자로 받아, 이벤트 리스너를 추가하는 메서드이다. 이렇게 \texttt{addEventListener} 메서드를 이용한 방법이 가장 권장되는 방법이다.
