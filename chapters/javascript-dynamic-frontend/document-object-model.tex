...
DOM에서 제공하는 메서드를 이용하여 HTML 요소를 조회(query)할 수 있다. \coderef{code:dom-example-html}\을 웹 브라우저에서 열고, 개발자 도구의 REPL Shell을 이용하여 DOM에서 제공하는 메서드를 사용해보고, HTML 문서가 어떻게 수정되는지 확인해보자.
